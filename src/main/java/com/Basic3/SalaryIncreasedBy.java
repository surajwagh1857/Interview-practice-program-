...
public class SalaryIncreasedBy {
...
List incre_Salary_list=list.stream().map(a->{a.setSalary(a.getSalary()+50);return a;}).collect(Collectors.toList());
	System.out.println(incre_Salary_list );
