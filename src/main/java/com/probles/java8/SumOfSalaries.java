...
public static void main(String[] args) {
	...
	int sumof_salaries=list.stream().collect(Collectors.summingInt(Person::getSalary));
	System.out.println(sumof_salaries);
	
	int sumodselectedSalary2=list.stream().filter(a->a.getSalary()>5000).collect(Collectors.summingInt(Person::getSalary));
	System.out.println(sumodselectedSalary2);
