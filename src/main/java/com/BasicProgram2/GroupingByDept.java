...
public static void main(String[] args) {
	...
	Map<Object,Long>group_byDept=list.stream().collect(Collectors.groupingBy(a->a.getDepartment(),Collectors.counting()));

    System.out.println("Group by dept-->"+group_byDept);
