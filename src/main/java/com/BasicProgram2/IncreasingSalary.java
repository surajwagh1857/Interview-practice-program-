...
public static void main(String[] args) {
	...
	List<Person> increased_Salary=list.stream().map(a->{a.setSalary(a.getSalary()+50);return a;}).collect(Collectors.toList());
	
	System.out.println("Increased salary ---->"+increased_Salary);
