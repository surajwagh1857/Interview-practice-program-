...
public static void main(String[] args) {
	...
	Object list1=list.stream().collect(Collectors.groupingBy(Person::getSalary));
	System.out.println("list according to salary-->"+list1);
	
	Map<Object, Long> list2=list.stream().collect(Collectors.groupingBy(a->a.getSalary(),Collectors.counting()));
	
	System.out.println("group by salary----> "+list2);
